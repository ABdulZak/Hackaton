...
public class Activity_9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seeds = findViewById(R.id.button36);
        settings = findViewById(R.id.button37);
        notifications = findViewById(R.id.button21);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v){
                nineThird(Activity_3.class);
            }
        });
    ...
    public void nineThird(Class clas){
